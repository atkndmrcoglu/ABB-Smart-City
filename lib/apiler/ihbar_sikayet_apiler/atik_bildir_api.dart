...
class AmbalajAtikService {
  //Kendi backend API url adresinizi buraya yazın
  ...
  Future<bool> gonderAmbalajAtik({
    ...
    try {
      // Backend tarafındaki endpoint rotasını düzenleyin (örn: /gonder veya /bildir)
      ...
      //  Eğer backend tarafında her istekte Bearer Token (Yetkilendirme) isteniyorsa alt satırı aktif edin:
      ...
      if (fotoPath != null && fotoPath.isNotEmpty) {
        ...
        if (await fotoDosyasi.exists()) {
          // 'fotograf' anahtar kelimesini (key), backend'in istekte beklediği isimle değiştirin (örn: 'image', 'file', 'atik_gorsel')
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        // Sunucudan dönen yanıt mesajını okumak isterseniz alt satırı kullanabilirsiniz:
