...
import 'package:smartcity/apiler/sehir_rehberim_apiler/alisveris_merkezleri_api.dart' as alisveris_api;
import 'package:smartcity/apiler/sehir_rehberim_apiler/spor_api.dart' as spor_api;

class AlisverisSpor extends StatefulWidget {
  const AlisverisSpor({super.key});

  @override
  State<AlisverisSpor> createState() => _AlisverisSporState();
}

class _AlisverisSporState extends State<AlisverisSpor> with SingleTickerProviderStateMixin {
  late TabController _tabController;
  final alisveris_api.AlisVerisApi _alisverisApi = alisveris_api.AlisVerisApi();
  final spor_api.SporApi _sporApi = spor_api.SporApi();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          indicatorWeight: 2,
          tabs: const [
            Tab(text: "Alışveriş Mrk."),
            Tab(text: "Spor Tesisleri"),
          ],
        ),
      ),
      body: TabBarView(
